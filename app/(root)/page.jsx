// Copyright (C) 2025 Edwin Ronaltama Mabrur
// Portfolio Website - CSS Scroll-Snap Version
				...
				<div className="mx-auto container grid grid-cols-1 md:grid-cols-3 gap-4 p-10 overflow-hidden md:px-20">
					<motion.div
						...
						<div className="block md:hidden col-span-1 mx-auto my-10">
							<div className="bg-slate-500 rounded-full h-60 w-60 grayscale hover:grayscale-0 active:grayscale-0 transition-all ease duration-300">
								<Image
									src={Me}
									width={500}
									height={500}
					...
					<motion.div
						...
						<div className="rounded-full h-auto w-auto  lg:px-12 grayscale hover:grayscale-0 active:grayscale-0 transition-all ease duration-300">
							<Image
								src={Me}
								width={400}
								height={550}
			...
			<section id="about" className="snap-start h-screen flex items-center justify-center">
				<div className="relative md:h-screen w-screen gap-4 flex justify-center items-center flex-col overflow-hidden">
					<div className="z-0 mb-48 md:mb-0  md:absolute top-1/4  md:right-[10%] md:-translate-y-16 ">
						<motion.div
							className="bg-slate-300 rounded-sm h-[400px] md:h-[600px] w-[80vw] md:w-[30vw] grayscale hover:grayscale-0 active:grayscale-0"
							initial={{
								x: 300,
								opacity: 0,
								z: -100,
				...
				<div className="relative md:h-screen w-screen  gap-4 p-10 flex justify-center items-center flex-col overflow-hidden">
					...
					<div className="z-10 w-full absolute md:w-auto  md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 overflow-hidden">
						...
						<motion.p
							...
							<a href="mailto:tama.ronal@gmail.com?subject=Hello&body=Hello Ronaltama,">
								tama.ronal@gmail.com
							</a>
						</motion.p>
						{/* icons */}
						<div className="flex justify-center items-center space-x-4">
							<motion.a
								href="mailto:tama.ronal@gmail.com?subject=Hello&body=Hello Ronaltama,"
							...
							<motion.a
								href="https://github.com/ronaltama"
								target="_blank"
								rel="noopener noreferrer"
								className="flex justify-center items-center bg-gray-700 w-14 h-14 rounded-full text-gray-100 hover:bg-gray-400 transition-all ease-in-out duration-300"
							...
							<motion.a
								href="https://www.instagram.com/ronaltama"
								target="_blank"
								rel="noopener noreferrer"
								className="flex justify-center items-center bg-gray-700 w-14 h-14 rounded-full text-gray-100 hover:bg-gray-400 transition-all ease-in-out duration-300"
								initial={{ opacity: 0, y: 40 }}
							...
							<motion.a
								href="https://linkedin.com/in/ronaltama"
								target="_blank"
								rel="noopener noreferrer"
								className="flex justify-center items-center bg-gray-700 w-14 h-14 rounded-full text-gray-100 hover:bg-gray-400 transition-all ease-in-out duration-300"
								initial={{ opacity: 0, y: 40 }}
